  ...
  return (
    <div className="mt-28 flex flex-col items-center">
      ...
      <p className="mt-10 w-1/3 text-center text-base font-medium text-white">
        I'm Conrad Hunter, a 24-year-old frontend developer. I take pride in
        crafting visually stunning and easy-to-use web interfaces. With a keen
        attention to detail and a deep understanding of user experience, I
