...
function TechStack() {
  return (
    <div className="mb-20">
      ...
      <div className="md:gird-rows-2 grid grid-cols-4 grid-rows-2 gap-14 max-[640px]:grid-cols-2 max-[640px]:grid-rows-4 max-[425px]:grid-cols-2 max-[425px]:grid-rows-4 sm:grid-cols-3 sm:grid-rows-4 md:grid-cols-4">
